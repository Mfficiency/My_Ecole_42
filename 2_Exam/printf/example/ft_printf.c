...
static char	*ft_substr(char const *str, int start, int length)
{
	int i;
	char *cpy;
	int str_length;
...
static int str_write(t_str *str)
{
	int total;
	int length;
...
static int parse_flags(char const *flags, int *width, int *precision)
{
	int i;
	int state;
	int tmp;
...
static char *malloc_decimal(int length, int precision)
{
	char *str;
	int i;
...
static char	*format_signed(int width, int precision, int val)
{
	char *str;
	int tmp;
	long ltmp;
...
static char	*format_hex(int width, int precision, unsigned int val)
{
	unsigned int tmp;
	int nbr_length;
	int length;
...
static char	*format_str(int width, int precision, char *str)
{
	char *cpy;
	int str_length;
	int length;
...
static char	*format_missing(char const *flags, char format)
{
	char *str;
	int length;
	int i;
...
static int add_format(t_str **str, char *flags, char d, va_list *args)
{
	char *mat;
	int width;
	int precision;
...
static int clear_all(t_str **str, va_list *args)
{
	str_clear(str);
	va_end(*args);
	return (0);
